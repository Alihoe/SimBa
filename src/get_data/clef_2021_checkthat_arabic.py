...
def run():
    ...
    general_path = "../../data/clef_2021_checkthat_arabic"
    ...
    corpus_filepath = "../../data/clef_2021_checkthat_arabic/corpus"
    ...
    gold_file_path = "../../data/clef_2021_checkthat_arabic/gold.tsv"
