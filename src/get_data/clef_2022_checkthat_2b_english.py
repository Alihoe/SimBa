...
def run():
    Path("../../data/clef_2022_checkthat_2b_english").mkdir(parents=True, exist_ok=True)
    ...
    with open("../../data/clef_2022_checkthat_2b_english/queries.tsv", 'wb') as f:
    ...
    corpus_filepath = "../../data/clef_2022_checkthat_2b_english/corpus"
    ...
    with open("../../data/clef_2022_checkthat_2b_english/gold.tsv", 'wb') as f:
