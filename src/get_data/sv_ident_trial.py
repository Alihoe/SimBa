...
def run():
    ...
    queries_path_en = general_path + "/queries_en.tsv"
    queries_path_de = general_path + "/queries_de.tsv"
    qrels_path_en = general_path + "/gold_en.tsv"
    qrels_path_de = general_path + "/gold_de.tsv"
    ...
    with open(queries_path_de, 'wb') as f:
        ...
        f.write(queries_qrels_de_train)
    ...
    targets_path_en = general_path + "/corpus_en.tsv"
    ...
    targets_path_de = general_path + "/corpus_de.tsv"
