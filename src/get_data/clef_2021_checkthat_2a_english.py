...
def run():
    ...
    general_path = "../../data/clef_2021_checkthat_2a_english"
    ...
    corpus_filepath = "../../data/clef_2021_checkthat_2a_english/corpus"
    ...
    gold_file_path = "../../data/clef_2021_checkthat_2a_english/gold.tsv"
